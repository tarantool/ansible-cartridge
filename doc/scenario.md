...
- `cartridge_install_dir` - path to directory with packages;
- `cartridge_instances_dir` - path to directory with instances links to packages.
...
Update instance links for a new version of package (if multiple package versions is enabled).
